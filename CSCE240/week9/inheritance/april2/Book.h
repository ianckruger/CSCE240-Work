...
class Book {
 ...
 public:
  ...
  // function to modify the title of an existing chapter
  void SetChapterTitle(int chapter_number, string chapter_title);

  // function to insert a new chapter amongst the existing chapters
  // (keep, don't change, the existing chapters)
